...
Page({
  ...
  data: {
    ...
    page:1,
    orderList:[],
    statusList: ['审核不通过', '待审核', '已审核', '已上浆', '已分配', '已打印', '已蒸花', '已检验', '已发货', '退货'],
    fabricList:[],
    orderSatausList:[],
    date:'2016-09-01',
    imgBaseUrl:''
    ...
    switch(key){
      ...
      case '订单状态':
        ...
        switch(this.data.userType){
          case 1:
            orderStatus = ['审核不通过', '待审核', '已审核', '已上浆', '已分配', '已打印', '已蒸花', '已检验', '已发货', '退货','已取消'];
            break;
          case 2:
            orderStatus = ['审核不通过', '待审核', '已审核', '已上浆', '已分配', '已打印', '已蒸花', '已检验', '已发货', '退货','已取消'];
            break;
          case 3:
            orderStatus = ['审核不通过', '待审核', '已审核', '已上浆', '已分配', '已打印', '已蒸花', '已检验', '已发货', '退货'];
            break;
          case 4:
            orderStatus = ['已审核','已分配'];
            break;
          case 5:
            orderStatus = ['已分配', '已打印', '已蒸花','已上浆'];
            break;
          case 6:
            orderStatus = ['已打印', '已蒸花','已上浆']
            break;
          default:
            break;
        }
